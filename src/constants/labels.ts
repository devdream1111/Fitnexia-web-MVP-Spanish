...
export const MOCK_V2V3_LABELS = {
  ...
  creditsApply: 'Usar créditos en esta reserva',
  creditsApplied: 'Créditos aplicados (demostración)',
  ...
  liveStreamTitle: 'Clase en vivo',
  liveStreamJoin: 'Unirse a la transmisión',
  liveStreamMeetingId: 'ID de reunión',
  liveStreamPasscode: 'Código',
  ...
  replySaved: 'Respuesta publicada (demostración).',
  ...
  supportTicketSent: 'Ticket enviado. Te responderemos por correo (simulado).',
  supportStatus: {
    open: 'Abierto',
  ...
  analyticsWeekly: 'Resumen semanal',
  ...
  courtBookingConfirmed: 'Reserva de cancha confirmada (demostración).',
  courtTypes: {
    padel: 'Pádel',
    tennis: 'Tenis',
    football_5: 'Fútbol 5',
